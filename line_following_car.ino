#define enA 10//Enable1 L293D Pin enA 
#define in1 9 //Motor1  L293D Pin in1 
#define in2 8 //Motor1  L293D Pin in1 
#define in3 7 //Motor2  L293D Pin in1 
#define in4 6 //Motor2  L293D Pin in1 
#define enB 5 //Enable2 L293D Pin enB 
...
pinMode(enA, OUTPUT); // declare as output for L293D Pin enA 
...
pinMode(enB, OUTPUT); // declare as output for L293D Pin enB 
...
void loop(){  
if((digitalRead(R_S) == 1)&&(digitalRead(L_S) == 1)){forword();}   //if Right Sensor and Left Sensor are at White color then it will call forword function
